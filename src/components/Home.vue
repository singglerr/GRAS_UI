				...
				<div class="col-md-3  welcome-grid text-center">
					<div class="ih-item circle effect9 left_to_right">
						<a href="ведение гериатрических карт.html" target="_blank">
							...
							<div class="info">
								<p>&nbsp;</p>
								<p>&nbsp;</p><h4>Формирование, редактирование, хранение и обработка данных цифровой
								версии
								гериатрической карты пациента</h4>
							</div>
						</a>
					</div>
				</div>
				...
				<div class="col-md-3 welcome-grid text-center">
					<div class="ih-item circle effect9 left_to_right">
						<a href="#">
							...
							<div class="info">
								<p>&nbsp;</p>
								<p>&nbsp;</p><h4>Обработка информации для проведения медико-статистического анализа
								данных в
								гериатрии</h4>
							</div>
						</a>
				...
				<div class="col-md-3 welcome-grid text-center">
					<div class="ih-item circle effect9 left_to_right">
						<a href="ИМТ.html" target="_blank">
							...
							<div class="info">
								<p>&nbsp;</p>
								<p>&nbsp;</p><h4>Оценка у больного гериатрических показателей физического и психического
				...
				<div class="col-md-3 welcome-grid text-center">
					<div class="ih-item circle effect9 left_to_right">
						<a href="#">
							...
							<div class="info">
								<p>&nbsp;</p>
								<p>&nbsp;</p><h4>Построение и формализация множества схем лечения конкретной
								нозологии</h4>
							</div>
						</a>
					</div>
				...
				<div class="col-md-3 welcome-grid text-center">
					<div class="ih-item circle effect9 left_to_right">
						<a href="#">
							...
							<div class="info">
								<p>&nbsp;</p>
								<p>&nbsp;</p><h4>Многокритериальная оценка эффективности врачебного вмешательства</h4>
							</div>
						</a>
					</div>
				</div>
				...
				<div class="col-md-3 welcome-grid text-center">
					<div class="ih-item circle effect9 left_to_right">
						<a href="#">
							...
							<div class="info">
								<p>&nbsp;</p>
								<p>&nbsp;</p><h4>Исследование,решение проблем управления индивидуальными и групповыми
								рисками в
								гериатрии</h4>
							</div>
						</a>
				...
				<div class="col-md-3 welcome-grid text-center">
					<div class="ih-item circle effect9 left_to_right">
						<a href="#">
							...
							<div class="info">
								<p>&nbsp;</p>
								<p>&nbsp;</p><h4>Систематизация и визуализация рисков гериатрических больных</h4>
							</div>
						</a>
					</div>
				</div>
				...
				<div class="col-md-3 welcome-grid text-center">
					<div class="ih-item circle effect9 left_to_right">
						<a href="#">
							...
							<div class="info">
								<p>&nbsp;</p>
								<p>&nbsp;</p><h4>Выбор лучшего для пациента набора лечебно-профилактических
								процедур</h4>
							</div>
						</a>
					</div>
	...
	export default {
		...
		head: {
			...
			link: [
				...
				{
					rel: "stylesheet",
					href: "https://bootstraptema.ru/snippets/effect/2017/ihover9/ihover.css"
				},
				{
					rel: "stylesheet",
